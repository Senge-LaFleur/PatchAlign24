...
# ============================================================
n_epochs     = 20
dev_mode     = 'full'       # 'dev' or 'full'
dataset_name = 'fitzpatrick'
model_name   = 'PATCHALIGN_FITZ_OUTDOMAIN_LMI'
lambda_mi    = 0.1

# Out-domain: choose your split (0–3)
domain_index = 1  # 0=random_holdout | 1=a12 | 2=a34 | 3=a56

# Reproducibility (matches base OutDomain script)
torch.manual_seed(2)
random.seed(2)
np.random.seed(2)

print(f'Config | dataset={dataset_name} | model={model_name} | epochs={n_epochs} | lambda_mi={lambda_mi} | domain_index={domain_index}')
